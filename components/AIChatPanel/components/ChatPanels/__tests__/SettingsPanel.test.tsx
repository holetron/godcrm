...
vi.mock('@/features/ai-chat/components/SubAgentSelector', () => ({
  SubAgentSelector: ({ value, onChange, disabled }: { value: number[]; onChange: (rowIds: number[]) => void; disabled: boolean }) => (
    <div data-testid="sub-agent-selector">
      <button
...
describe('SettingsPanel', () => {
  ...
  describe('AI Settings Tab', () => {
    ...
    it('should render SubAgentSelector', () => {
      renderWithProviders(<SettingsPanel {...defaultProps} />);
      
      expect(screen.getByTestId('sub-agent-selector')).toBeInTheDocument();
    });
  });
