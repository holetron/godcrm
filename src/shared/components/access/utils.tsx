/**
 * Utility functions for UserAccessPanel
 */
...
export const getLevelIcon = (level: UserAccessLevel) => {
  switch (level) {
    case 'owner_owner': return <Crown className="w-4 h-4" />;
...
/** Compute effective roles for a user at a given entity level, considering hierarchy */
