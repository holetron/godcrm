...
describe('ChatInput', () => {
  ...
  describe('Row Binding', () => {
    ...
    it('should toggle row binding when button clicked', () => {
      ...
      // The bind button shows a Link2 icon with title="Привязать строку"
      const bindButton = screen.getByTitle('Привязать строку');
    ...
    it('should show bound rows count', () => {
      ...
      // The bound rows count is shown as a badge number inside the bind button
